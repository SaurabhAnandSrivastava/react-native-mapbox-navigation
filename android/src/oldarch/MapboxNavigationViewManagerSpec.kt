...
abstract class MapboxNavigationViewManagerSpec<T : View> : SimpleViewManager<T>() {
  ...
  abstract fun setStops(view: T?, value: ReadableArray?)
  abstract fun updateDriverLocations(view: T?, value: ReadableArray?)
  ...
  abstract fun setWaypointMarker(view: T?, value: ReadableArray)
  abstract fun setIsPreview(view: T?, value: Boolean)
